        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    url.set("https://github.com/meshnesh/androidkotlinboilerplate/")
                    ...
                    scm {
                        connection.set("scm:git:git://github.com/meshnesh/androidkotlinboilerplate.git")
                        developerConnection.set("scm:git:ssh://github.com/meshnesh/androidkotlinboilerplate.git")
                        url.set("https://github.com/meshnesh/androidkotlinboilerplate/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/meshnesh/androidkotlinboilerplate/issues")
                    }
                }
            }
        }
